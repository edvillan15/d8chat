        ...
        <Col sm={8} lg={6} xl={5} className="col-xxl-4">
          <div className="py-md-5 py-4">
            <AuthHeader
              ...
              subtitle="Discover a new level of connectedness with D8 Chat, the ultimate chat application designed for modern communication. Join our thriving community today and unlock a world of seamless communication and collaboration."
            />
            ...
            >
              ...
              <div className="mb-4">
                <p className="mb-0">
                  By registering you agree to the D8 Chat{" "}
